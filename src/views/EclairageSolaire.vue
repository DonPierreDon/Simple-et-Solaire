<template>
      ...
      <div class="flex flex-wrap w-1/6">
        <div class="w-full p-1 md:p-2">
          <img
            ...
            src="/assets/img/LumSolaire1.jpg"
          />
        </div>
      </div>
      <div class="flex flex-wrap w-1/6">
      ...
      <div class="flex flex-wrap w-1/3">
        <div class="w-full p-1 md:p-2">
          <ul class="list-disc ml-16">
            <li>Kit éclairage solaire Ulitium Blanc</li>
            <li>Kit éclairage solaire T-LITE Blanc</li>
            <li>JouLite Kit 1 Sundaya</li>
            <li>JouleStick Kit Sundaya</li>
          </ul>
        </div>
      </div>
      <div class="flex flex-wrap w-1/3">
        <div class="w-full p-1 md:p-2">
          <ul class="list-disc ml-16">
            <li>Lampe solaire T-LITE</li>
            <li>Lampe solaire Ulitium 200 Sundaya</li>
            <li>Batterie solaire Ulitium</li>
            <li>Batterie solaire de rechange T-Lite</li>
          </ul>
        </div>
      </div>
      <div class="flex flex-wrap w-1/3">
        <div class="w-full p-1 md:p-2">
          <ul class="list-disc ml-16">
            <li>Dragonne Sundaya pour Kits solaire Sundaya</li>
            <li>Neo20 Hybrid</li>
            <li>NeoBank</li>
            <li>Et aussi l'étude de votre projet personnalisé</li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="text-center mt-20">
    <p class="pt-1">
      ...
      d'autonomie solaire à Argeliers.
    </p>
    <p class="pt-1">Retrouvez nos produits sur notre site de vente en ligne</p>
  </div>
</template>

<script>
export default {
  name: "formationSolaire",
};
</script>
